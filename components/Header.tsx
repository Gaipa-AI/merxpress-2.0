            ...
            <div className="flex items-center space-x-5 ">
                ...
                <div className="relative ">
                    ...
                    {/* <img src='icons/cart-outline.svg' className='h-10 w-10 fill-white '/> */}
                     <ShoppingCart className='w-full h-8 stroke-white hover:stroke-red-500' strokeWidth={1.0} fill='none' href='/cart' />
                    {/* <span className="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full px-1">{cartCount}</span> */}
                    
                </div>
                <a href="/cart" className="text-gray-400 hover:text-red-500">Cart</a>
                </div>
                <div className="">
