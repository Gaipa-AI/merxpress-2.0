...
import { ShieldAlert, Github, KeyIcon } from "lucide-react";
          ...
          <form className="p-6 md:p-8" action={formAction} >
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="w-full" onClick={()=> signIn("auth0", { callbackUrl: "/dashboard" })}>
                  ...
                  <KeyIcon className="h-5 w-5 stroke-gray-800" />
                  <span className="sr-only">Login with Auth0</span>
                </Button>
                <Button variant="outline" type="button" className="w-full" onClick={() => signIn("google", { callbackUrl: "/cart" })}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                ...
                <Button variant="outline" type="button" className="w-full" onClick={()=> signIn("github")}>
                  ...
                  <TooltipProvider>
                    ...
                    <TooltipTrigger asChild>
                      <Github className="h-5 w-5 stroke-gray-800" />
                      </TooltipTrigger>
